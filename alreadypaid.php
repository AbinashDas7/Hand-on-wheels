...
<div class="feature minheightset">
		...
		<div class="container">
			...
			<div class="row feature_row">
				...
				<div class="content_section_title_after_login">Already Paid</div>
			 	<div class="text-danger" style="padding-top:20px;">
 <i class="fa fa-close" aria-hidden="true"></i> We found you have already paid for this course, so please select a different seminar and pay. </div>
